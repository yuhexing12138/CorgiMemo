buildscript {
    dependencies {
        // KSP buildscript classpath 同步升级到 2.3.10，与 libs.versions.toml 中的 KSP 插件版本保持一致
        classpath("com.google.devtools.ksp:com.google.devtools.ksp.gradle.plugin:2.3.10")
...
// 全局强制 kotlin-metadata-jvm 版本：Kotlin 2.4.0 产生 metadata 2.4.0，
// Hilt/Dagger 内部 shaded 的旧版本仅支持到 2.3.0，强制解析到 2.4.0 确保兼容。
subprojects {
    configurations.all {
        resolutionStrategy {
